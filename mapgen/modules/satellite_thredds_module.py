...
def generate_mapfile(regexp_pattern_module, netcdf_path):
    ...
    map_file_name = os.path.join("/tmp", netcdf_file_name + ".map")
    redered_map_template = mt.render(layers=layers_render_data, map_file_name=map_file_name)
